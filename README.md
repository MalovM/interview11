1. Создайте fork репозитория https://github.com/MyITschool/Interview11 в своём аккаунте на ginhub.com
...
c) Расположите элементы div, как это схематично показано в файле image01.png.
...
3. Создайте pull request в ветку main репозитория https://github.com/MyITschool/Interview11.
4. Загрузите видеозаись в облачное хранилище и ссылку на видеозапись поместите в комментарий к pull requst’у.
